...
export class ProductCategoriesComponent {
  ...
  readonly applications: ApplicationType[] = ['External', 'Internal', 'Heavy Duty'];
  readonly surfaces: SurfaceType[] = ['Steel', 'Concrete', 'Aluminum', 'Mixed'];
  readonly industries: IndustryType[] = ['Automotive', 'Marine', 'Infrastructure', 'Manufacturing', 'Energy'];
